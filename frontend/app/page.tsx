  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto w-full max-w-[1280px] bg-sky-100 px-4 py-10 md:w-[calc(100%-200px)]">
        <main className="space-y-14">
        <header className="mx-auto max-w-[1080px] px-[5em] space-y-6 text-center">
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="relative h-14 w-14 overflow-hidden rounded-2xl bg-white ring-1 ring-slate-200 sm:h-16 sm:w-16">
                <Image
                  src="/icon.png"
                  alt="Aquirise"
                  fill
              ...
              <div className="flex items-baseline gap-3">
                <div className="font-display text-5xl font-semibold tracking-[0.10em] text-slate-900 sm:text-6xl">
                  Aquirise
                </div>
          ...
          <div className="space-y-7 pt-6">
            <h1 className="font-display text-[34px] font-semibold leading-[1.15] tracking-tight sm:text-[34px] md:text-[46px]">
            ...
            <p className="mx-auto max-w-[1080px] px-[5em] pt-3 text-left text-[26px] leading-snug text-slate-700 sm:text-[26px]">
              人気投票とクーポン配布を、一つにつないだ、リワード型のエンゲージメント基盤です。
              参加のきっかけから次のアクションまで、流れるユーザ体験を実現します。
            </p>

            <div className="mx-auto w-full max-w-[1080px] px-[5em] space-y-6 pt-[5em]">
              <div className="space-y-6">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-left shadow-sm transition duration-200 ease-out hover:-translate-y-1 hover:shadow-xl">
        ...
        <div className="mx-auto w-full max-w-[1080px] rounded-3xl bg-transparent px-[5em] py-6 sm:py-8">
          <div className="flex flex-col gap-[6.5rem]">
            <div className="flex flex-col gap-10">
            <section className="space-y-3 pt-[5rem] text-center">
            ...
            <section>
              <div className="grid gap-8 lg:grid-cols-3">
                <div className="rounded-3xl bg-sky-300/45 p-6 ring-1 ring-sky-400/60">
            ...
            <section className="rounded-3xl bg-sky-50/0 px-3 pb-3 sm:px-4 sm:pb-4">
              <div className="p-2 sm:p-0">
                ...
                <div className="mt-8 grid gap-6 lg:grid-cols-3">
                  <article className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm">
                    <div
                      className="mb-4 flex h-28 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-sky-100/90 to-indigo-50/90 ring-1 ring-slate-200/80"
                      aria-hidden="true"
                    >
                      <svg viewBox="0 0 140 100" className="h-24 w-auto text-indigo-600" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="8" y="12" width="48" height="36" rx="3" className="fill-white/50" />
                        <path d="M16 22h32M16 30h20M16 38h24" className="stroke-slate-400" strokeWidth="1.2" />
                        <path d="M88 20h20v6h-20z" className="fill-amber-100" stroke="currentColor" />
                        <path d="M84 44h32l4 8h-40l4-8z" className="fill-slate-100" />
                        <path d="M50 32 L70 32 L64 50" className="stroke-rose-400" strokeWidth="1.4" strokeDasharray="3 2" />
                        <circle cx="100" cy="64" r="9" className="fill-indigo-100" />
                        <path d="M100 60v4M100 70h.01" className="stroke-indigo-600" />
                        <path d="M20 70c8-2 20-2 32 0c10 2 24 1 32-1" className="stroke-rose-300" strokeWidth="1.2" />
                      </svg>
                    </div>
                  ...
                  <article className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm">
                    <div
                      className="mb-4 flex h-28 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-violet-100/80 to-sky-50/90 ring-1 ring-slate-200/80"
                      aria-hidden="true"
                    >
                      <svg viewBox="0 0 140 100" className="h-24 w-auto text-violet-600" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="8" y="40" width="36" height="40" rx="3" className="fill-white/70" />
                        <rect x="50" y="32" width="40" height="48" rx="3" className="fill-violet-100" />
                        <rect x="98" y="40" width="36" height="40" rx="3" className="fill-white/70" />
                        <ellipse cx="70" cy="20" rx="12" ry="6" className="fill-violet-200" stroke="currentColor" />
                        <circle cx="70" cy="20" r="2.2" className="fill-violet-700" stroke="none" />
                        <path d="M20 20h-6M20 20v-6" className="stroke-amber-500" strokeWidth="1.3" />
                        <path d="M124 20h6M124 20v-6" className="stroke-amber-500" strokeWidth="1.3" />
                        <path d="M18 88c20-3 40-3 64 0c20 2 36 1 44-1" className="stroke-slate-300" strokeWidth="1.2" fill="none" />
                      </svg>
                    </div>
                  ...
                  <article className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm">
                    <div
                      className="mb-4 flex h-28 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-100/70 to-sky-50/90 ring-1 ring-slate-200/80"
                      aria-hidden="true"
                    >
                      <svg viewBox="0 0 140 100" className="h-24 w-auto text-emerald-600" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="36" cy="30" r="6" className="fill-amber-100" />
                        <path d="M32 40h8l-4 12z" className="fill-amber-200" stroke="none" />
                        <rect x="52" y="28" width="32" height="24" rx="2" className="fill-white/80" />
                        <path d="M58 36h20M58 40h12" className="stroke-slate-400" strokeWidth="1.2" />
                        <path d="M96 20v44M96 64l-8-8M96 64l8-8" className="stroke-emerald-500" strokeWidth="1.4" />
                        <path d="M20 80h12l4-6 6 10h12" className="stroke-slate-400" strokeWidth="1.2" fill="none" />
                        <rect x="100" y="50" width="20" height="16" rx="1" className="fill-emerald-100" />
                        <path d="M104 58h4M110 60l4-4" className="stroke-emerald-700" strokeWidth="1.2" />
                      </svg>
                    </div>
            ...
            <section className="rounded-3xl bg-sky-50/0 px-3 pb-3 sm:px-4 sm:pb-4">
              <div className="p-2 sm:p-0">
                ...
                <div className="mx-auto mt-8 max-w-md rounded-2xl bg-sky-300/40 p-5 ring-1 ring-sky-400/60">
                  <ol className="list-none space-y-4 text-left text-base text-slate-700">
                    ...
                    <li className="flex gap-3 sm:gap-4">
                      ...
                      <span className="pt-0.5">登録するボタンを押す</span>
                    </li>
                    <li className="flex gap-3 sm:gap-4">
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/80 text-xs font-medium tabular-nums text-slate-500 ring-1 ring-slate-200/90 sm:h-8 sm:w-8 sm:text-[13px]">
                        3
                      </span>
                      <span className="pt-0.5">パスワードを取得する</span>
                    </li>
                  </ol>
                </div>
