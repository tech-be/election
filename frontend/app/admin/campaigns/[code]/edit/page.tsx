  ...
  return (
    <main className="w-full max-w-none space-y-6">
      ...
      <div className="space-y-6">
        <div
          className="mb-1 flex flex-wrap gap-1 border-b border-slate-800 pb-0"
          role="tablist"
          aria-label="企画編集の区分"
        >
          {EDIT_TABS.map((t) => {
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500">
            画像ファイルをアップロードすると、保存用URLが設定されます（「更新」でDBに反映）。
          </p>
          <input
        ...
        <div className="space-y-3 border-t border-slate-800 pt-4">
          <p className="text-xs text-slate-500">
            保存せずに一覧へ戻る場合は左の「閉じる」。変更を反映する場合は「更新」または「更新して閉じる」を押してください。
          </p>
